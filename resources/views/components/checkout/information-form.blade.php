<div>
    ...
    <div class="mt-6">
        ...
        <div class="mt-1">
            <x-text-input type="email" id="email-adress" name="email" autocomplete="email" placeholder="Digite seu email"
    ...
    <div class="mt-6">
        ...
        <div class="mt-1">
            <x-text-input type="text" id="name" name="name" autocomplete="name"
                placeholder="Digite seu nome completo" wire:model="user.name" />
        </div>
    ...
    <div class="mt-10">
        ...
        <div class="mt-6 grid grid-cols-6 gap-x-4 gap-y-6 sm:grid-cols-8">
            <div class="col-span-6 sm:col-span-2">
                ...
                <div class="mt-1">
                    <x-text-input type="text" id="zipcode" name="zipcode" placeholder="CEP" x-mask="99999-999"
                        wire:change="findAddress()" wire:model="address.zipcode" />
