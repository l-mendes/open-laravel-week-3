<form id="pix-checkout" x-show="$wire.method == '{{ $method }}'"
    @submit.prevent="pixOrBankSlipPayment('{{ $type }}')">
    ...
    <div class="py-4 grid grid-cols-6 gap-x-4 gap-y-6 sm:grid-cols-8">
        ...
        <div class="col-span-4 sm:col-span-8 flex justify-end">
            <x-primary-button type="submit" id="pix-pay" wire:loading.attr="disabled"
                wire:loading.class="opacity-50 cursor-not-allowed">Pagar</x-primary-button>
        </div>
