    ...
    <div class="mt-10">
        ...
        <div
            ...
            <label for="credit_card" class="flex flex-row gap-x-4 items-center py-4 cursor-pointer"
                @click="$wire.method = 1; creditCardPayment()">
            ...
            <label for="pix" class="flex flex-row gap-x-4 items-center py-4 cursor-pointer">
            ...
            <label for="bank_slip" class="flex flex-row gap-x-4 items-center py-4 cursor-pointer">
